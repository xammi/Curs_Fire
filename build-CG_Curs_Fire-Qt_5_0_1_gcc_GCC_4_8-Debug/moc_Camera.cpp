...
QT_MOC_LITERAL(4, 34, 12)
    ...
    "Camera\0throwException\0\0Exception&\0"
    "throwMessage\0"
};
...
void Camera::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Camera::*_t)(Exception & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Camera::throwException)) {
                *result = 0;
            }
        }
        {
            typedef void (Camera::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Camera::throwMessage)) {
                *result = 1;
            }
        }
    }
...
// SIGNAL 0
void Camera::throwException(Exception & _t1)
{
...
// SIGNAL 1
void Camera::throwMessage(QString _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
